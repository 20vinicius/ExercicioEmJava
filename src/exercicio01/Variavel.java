...
public class Variavel {
	public static void main(String args[]) {
		...
		//função long
		long varlong1 = 5000L;
		long varlong2 = 448684984849488849L;
		long varlong3 = 4486849848494888400L;
		...
		short varShort;
		varShort = 32767;
		System.out.println("valor de short: " +varShort);
	...
	//funçãofloat
		...
		palavra = palavra + "  está praticando syntax Java";
